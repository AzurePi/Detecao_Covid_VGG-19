...
if not os.path.exists("/VGG_19_Covid/dataset"):
    os.system('kaggle datasets download -d azaemon/preprocessed-ct-scans-for-covid19 --unzip -q')
    ...
    os.system(
        'mv "/VGG_19_Covid/dataset/Original CT Scans/NiCT" "/VGG_19_Covid/dataset/Original CT Scans/nCT" "/VGG_19_Covid/dataset"')
